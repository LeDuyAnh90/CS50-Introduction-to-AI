...
class MinesweeperAI():
    ...
    def __str__(self):
        return f"safe cells: {self.safes} \nmine cells: {self.mines}"
    ...
    def add_knowledge(self, cell, count):
        ...
        self.mark_safe(cell) # mark the call as safe
        
        # add new setence to knowledge base
        neighbor_cells = []
        for i in range(cell[0]-1,cell[0]+2):
            for j in range(cell[1]-1,cell[1]+2):
        ...
        # Mark guaranteed mines and safes, and infer new knowledge:
        # Loop until no new knowledge is inferred:
        new_knowledge = True
        while new_knowledge:
            new_knowledge = False
            safes = set()
            ...
            # Get safe and mine cells from knowledge base:
            for sentence in self.knowledge:
    ...
    def make_random_move(self):
        ...
        """
        if self.moves_made - self.mines:
            return random.choice(tuple(self.moves_made - self.mines))
